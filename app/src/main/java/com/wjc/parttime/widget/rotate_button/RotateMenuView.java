...
/**
 * Created by WJC on 2018/1/5 20:56
 * Describe : TODO
 */
public class RotateMenuView extends RelativeLayout implements View.OnClickListener {
    ...
    private static final int DEFULT_CENTER_ADD_SRC = R.drawable.comui_tab_post;//默认加号
    ...
    private OnRotateItemClickListener onRotateItemClickListner;
    ...
    public void setOnRotateItemClickListner(OnRotateItemClickListener onRotateItemClickListner) {
    ...
    private void initView(AttributeSet attrs) {
        ...
        backGroundColor = typedArray.getColor(R.styleable.RotateMenuView_back_ground_color, DEFULT_BACKGROUD_COLR);
